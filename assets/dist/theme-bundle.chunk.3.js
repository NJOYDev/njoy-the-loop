...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_nod__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_collapsible__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_models_forms__ = __webpack_require__(362);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__page_manager__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_reviews__ = __webpack_require__(418);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_collapsible__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_product_details__ = __webpack_require__(253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__product_video_gallery__ = __webpack_require__(419);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__common_collapsible__["a" /* default */])();this.productDetails=new __WEBPACK_IMPORTED_MODULE_4__common_product_details__["a" /* default */](__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productView'),this.context,window.BCData.product_attributes);__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__product_video_gallery__["a" /* default */])();var $reviewForm=__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__common_form_utils__["b" /* classifyForm */])('.writeReview-form');var review=new __WEBPACK_IMPORTED_MODULE_2__product_reviews__["a" /* default */]($reviewForm);__WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').on('click','[data-reveal-id="modal-review-form"]',function(){validator=review.registerValidation(_this3.context)});$reviewForm.on('submit',function(){if(validator){validator.performCheck();return validator.areAll('valid')}return false});var autoShip=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship-fake');var quantityBox=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.form-field--increments');// append auto ship options under quantity box
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(autoShip).insertAfter(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(quantityBox));// make fake select box hook into real one
var oneTimePurchaseSelect=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-oneTimePurchase');var subscribeSaveSelect=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-subscribeSave');var fakeSelects=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship-fake select option');var realSelects=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option');// const currentlySelectedFakeOption = $(fakeSelects).filter(':selected');
var fakeDropDown=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship-fake select');__WEBPACK_IMPORTED_MODULE_0_jquery___default()(fakeDropDown).on('change',function(){var currentlySelectedFakeOption=__WEBPACK_IMPORTED_MODULE_0_jquery___default()(fakeSelects).filter(':selected');__WEBPACK_IMPORTED_MODULE_0_jquery___default()(subscribeSaveSelect).prop('checked','checked');var fakeProductAttributeValue=__WEBPACK_IMPORTED_MODULE_0_jquery___default()(currentlySelectedFakeOption).data('option-select');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option').prop('selected',false);__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option[value='+fakeProductAttributeValue+']').prop('selected',true).change()});__WEBPACK_IMPORTED_MODULE_0_jquery___default()(subscribeSaveSelect).on('click',function(){var currentlySelectedFakeOption=__WEBPACK_IMPORTED_MODULE_0_jquery___default()(fakeSelects).filter(':selected');var fakeProductAttributeValue=__WEBPACK_IMPORTED_MODULE_0_jquery___default()(currentlySelectedFakeOption).data('option-select');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option').prop('selected',false);__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option[value='+fakeProductAttributeValue+']').prop('selected',true).change()});__WEBPACK_IMPORTED_MODULE_0_jquery___default()(oneTimePurchaseSelect).on('click',function(){var fakeProductAttributeValue=__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('one-time-purchase');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option').prop('selected',false);__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-autoship select option[value='+fakeProductAttributeValue+']').prop('selected',true).change()});// handlebars doesn't allow for banner text to be inside of anchor tag, so we append it here
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.product-banner-link').append(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.product--banner-cta'));next()};Product.prototype.after=function after(next){this.productReviewHandler();next()};Product.prototype.productReviewHandler=function productReviewHandler(){if(this.url.indexOf('#write_review')!==-1){this.$reviewLink.click()}};return Product}(__WEBPACK_IMPORTED_MODULE_1__page_manager__["a" /* default */]);// const autoShip = $('.js-autoship-fake');
