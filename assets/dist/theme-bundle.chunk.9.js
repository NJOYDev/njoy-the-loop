...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_models_forms__ = __webpack_require__(362);
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('.form--test').on('change',function(){//email
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="EMAIL_ADDRESS_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Email Address"]').val());//first name
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="FIRST_NAME"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="First Name"]').val());//last name
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="LAST_NAME"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Last Name"]').val());//company name
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="COMPANY_NAME"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Company Name"]').val());//phone number
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="PHONE_NUMBER"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Phone Number"]').val());//Billing Address line 1
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="POSTAL_STREET_1_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Billing Address Line 1"]').val());//Billing Address line 2
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="POSTAL_STREET_2_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Billing Address Line 2"]').val());//city
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="CITY_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="City"]').val());//Country
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="COUNTRY_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Country"]').val());//State
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="STATE_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="State"]').val());//Zip code
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="POSTAL_CODE_"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="Zip Code"]').val());//Date of Birth (month)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="FormFieldMonth"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="month"]').val());//Date of Birth (day)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="FormFieldDay"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="day"]').val());//Date of Birth (year)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="FormFieldYear"]').val(__WEBPACK_IMPORTED_MODULE_2_jquery___default()('[data-label="year"]').val())});//Date of Birth (month)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_day').on('change',function(){var thisValue=__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_day').val();__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#month_value').val(thisValue)});//Date of Birth (day)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_month').on('change',function(){var thisValue=__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_month').val();__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#day_value').val(thisValue)});//Date of Birth (year)
__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_year').on('change',function(){var thisValue=__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#FormField_33_year').val();__WEBPACK_IMPORTED_MODULE_2_jquery___default()('#year_value').val(thisValue)});// intuitsolutions validation start
var phoneSelector='form[data-create-account-form] [data-field-type="Phone"]';var $phoneElement=__WEBPACK_IMPORTED_MODULE_2_jquery___default()(phoneSelector);var zipSelector='form[data-create-account-form] [data-field-type="Zip"]';var $zipElement=__WEBPACK_IMPORTED_MODULE_2_jquery___default()(zipSelector);var fNameSelector='form[data-create-account-form] [data-field-type="FirstName"]';var $fNameElement=__WEBPACK_IMPORTED_MODULE_2_jquery___default()(fNameSelector);var lNameSelector='form[data-create-account-form] [data-field-type="LastName"]';var $lNameElement=__WEBPACK_IMPORTED_MODULE_2_jquery___default()(lNameSelector);var companySelector='form[data-create-account-form] [data-field-type="CompanyName"]';var $companyElement=__WEBPACK_IMPORTED_MODULE_2_jquery___default()(companySelector);$zipElement.attr('maxlength','5');// phone field must contain 10 digits or more
$phoneElement.attr({pattern:'[0-9]{10,}',title:'Please enter 10 Digits or More'});// phone number field being changed
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(phoneSelector+','+zipSelector).keypress(function(evt){// prevent anything but numbers
...
// fields
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(fNameSelector+','+lNameSelector+','+companySelector).keypress(function(event){if(event.keyCode>64&&event.keyCode<91||event.keyCode>96&&event.keyCode<123||event.keyCode==8||event.keyCode==32||event.keyCode==16){return true}else{event.preventDefault();// prevent from being typed
return false}});// prevent copy/paste the first, last, and company name fields
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(fNameSelector+','+lNameSelector+','+companySelector).on('copy paste',function(event){event.preventDefault()});// intuitsoltions validation end
