...
export default class Account extends PageManager {
 ...
 loaded(next) {
  ...
  const phoneSelector = 'form[data-address-form] [data-field-type="Phone"]';
  const $phoneElement = $(phoneSelector);
  const zipSelector = 'form[data-address-form] [data-field-type="Zip"]';
  const $zipElement = $(zipSelector);
  const fNameSelector = 'form[data-address-form] [data-field-type="FirstName"]';
  const $fNameElement = $(fNameSelector);
  const lNameSelector = 'form[data-address-form] [data-field-type="LastName"]';
  const $lNameElement = $(lNameSelector);
  const companySelector =
   'form[data-address-form] [data-field-type="CompanyName"]';
