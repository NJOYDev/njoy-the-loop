...
class FacetedSearch {
    ...
    bindEvents() {
        ...
        hooks.on('sortBy-submitted', this.onSortBySubmit);
         ...
         // close "fake dropdowns" when page reloads 
         const accordionNav = $('.accordion-navigation');
         const accordionContent = $('.accordion-content');
 
         $(accordionNav).removeClass('is-open').attr('aria-expanded','false')
         $(accordionContent).removeClass('is-open').attr('aria-hidden','true')
    }
